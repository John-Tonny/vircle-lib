...
HDPrivateKey.prototype._buildFromObject = function(arg) {
  ...
  let version = '';
  if (arg.network) {
    version = Network.get(arg.network).xprivkey;
    if (arg.useSegwit) {
      if (!arg.useMulti) {
        version = Network.get(arg.network).zprivkey;
      }else {
        version = Network.get(arg.network).Zprivkey;
      }
    }
  ...
  var buffers = {
    useSegwit: arg.useSegwit || false,
    useMulti: arg.useMulti || false,
    version: arg.network ? BufferUtil.integerAsBuffer(version) : arg.version,
...
HDPrivateKey.prototype._buildFromSerialized = function(arg) {
  let useSegwit = false;
  let useMulti = false;
  if (arg.indexOf('zprv') === 0) {
    useSegwit = true;
    useMulti = false;
  }else if(arg.indexOf('Zprv') === 0) {
    useSegwit = true;
    useMulti = true;
  }
 ...
 * @return HDPrivateKey
 */
HDPrivateKey.fromSeed = function(hexa, network, useSegwit, useMulti) {
  ...
  return new HDPrivateKey({
    useSegwit: useSegwit || false,
    useMulti: useMulti || false,
...
HDPrivateKey.prototype._buildFromBuffers = function(arg) {
  ...
  JSUtil.defineImmutable(this, {
    ...
    useSegwit: arg.useSegwit,
    useMulti: arg.useMulti
  });
